; ModuleID = '/home/curt/HeapDataFlow/benchmarkResults/memsafety/test-0235-2.bc'
source_filename = "/home/curt/HeapDataFlow/sv-benchmarks/c/memsafety/test-0235-2.c"
...
@.str.1 = private unnamed_addr constant [64 x i8] c"/home/curt/HeapDataFlow/sv-benchmarks/c/memsafety/test-0235-2.c\00", align 1
...
6:                                                ; preds = %3
  ...
  call void @l0_destroy(%struct.L0* %11, i32 1)
  %12 = load %struct.L0*, %struct.L0** @main.list, align 8
  call void @l0_destroy(%struct.L0* %12, i32 0)
  %13 = load %struct.L0*, %struct.L0** @main.list, align 8
  %14 = icmp ne %struct.L0* %13, null
  %15 = xor i1 %14, true
  %16 = xor i1 %15, true
