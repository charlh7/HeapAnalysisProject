; ModuleID = '/home/curt/HeapDataFlow/benchmarkResults/memsafety/test-0237.bc'
source_filename = "/home/curt/HeapDataFlow/sv-benchmarks/c/memsafety/test-0237.c"
...
@.str.1 = private unnamed_addr constant [62 x i8] c"/home/curt/HeapDataFlow/sv-benchmarks/c/memsafety/test-0237.c\00", align 1
...
4:                                                ; preds = %14, %1
  ...
  %6 = getelementptr inbounds %struct.L0, %struct.L0* %5, i32 0, i32 1
...
6:                                                ; preds = %11, %1
  ...
  %9 = load %struct.L1**, %struct.L1*** %2, align 8
  %10 = bitcast %struct.L1** %9 to i8*
  call void @l2_insert(%struct.L2** %8, i8* %10)
  br label %11
...
14:                                               ; preds = %11
  ...
  %16 = load %struct.L1*, %struct.L1** %3, align 8
  %17 = getelementptr inbounds %struct.L1, %struct.L1* %16, i32 0, i32 2
  store %struct.L1** %15, %struct.L1*** %17, align 8
  %18 = load %struct.L1**, %struct.L1*** %2, align 8
  %19 = load %struct.L1*, %struct.L1** %18, align 8
  %20 = load %struct.L1*, %struct.L1** %3, align 8
  %21 = getelementptr inbounds %struct.L1, %struct.L1* %20, i32 0, i32 1
  store %struct.L1* %19, %struct.L1** %21, align 8
  %22 = load %struct.L1*, %struct.L1** %3, align 8
  %23 = load %struct.L1**, %struct.L1*** %2, align 8
  store %struct.L1* %22, %struct.L1** %23, align 8
  ret void
}
...
; Function Attrs: noinline nounwind uwtable
define internal void @l2_insert(%struct.L2** %0, i8* %1) #0 {
  %3 = alloca %struct.L2**, align 8
  %4 = alloca i8*, align 8
  %5 = alloca %struct.L2*, align 8
  store %struct.L2** %0, %struct.L2*** %3, align 8
  store i8* %1, i8** %4, align 8
  %6 = call i8* @zalloc_or_die(i32 24)
  %7 = bitcast i8* %6 to %struct.L2*
  store %struct.L2* %7, %struct.L2** %5, align 8
  br label %8

8:                                                ; preds = %11, %2
  %9 = load %struct.L2*, %struct.L2** %5, align 8
  %10 = getelementptr inbounds %struct.L2, %struct.L2* %9, i32 0, i32 2
  call void @l3_insert(%struct.L3** %10)
  br label %11
...
14:                                               ; preds = %11
  ...
  %16 = bitcast i8* %15 to %struct.L1**
  %17 = load %struct.L2*, %struct.L2** %5, align 8
  %18 = getelementptr inbounds %struct.L2, %struct.L2* %17, i32 0, i32 0
  store %struct.L1** %16, %struct.L1*** %18, align 8
  %19 = load %struct.L2**, %struct.L2*** %3, align 8
  %20 = load %struct.L2*, %struct.L2** %19, align 8
  %21 = load %struct.L2*, %struct.L2** %5, align 8
  %22 = getelementptr inbounds %struct.L2, %struct.L2* %21, i32 0, i32 1
  store %struct.L2* %20, %struct.L2** %22, align 8
  %23 = load %struct.L2*, %struct.L2** %5, align 8
  %24 = load %struct.L2**, %struct.L2*** %3, align 8
...
6:                                                ; preds = %11, %1
  ...
  %9 = load %struct.L3**, %struct.L3*** %2, align 8
  %10 = bitcast %struct.L3** %9 to i8*
  call void @l4_insert(%struct.L4** %8, i8* %10)
  br label %11
...
14:                                               ; preds = %11
  ...
  %16 = load %struct.L3*, %struct.L3** %3, align 8
  %17 = getelementptr inbounds %struct.L3, %struct.L3* %16, i32 0, i32 2
  store %struct.L3** %15, %struct.L3*** %17, align 8
  %18 = load %struct.L3**, %struct.L3*** %2, align 8
  %19 = load %struct.L3*, %struct.L3** %18, align 8
  %20 = load %struct.L3*, %struct.L3** %3, align 8
  %21 = getelementptr inbounds %struct.L3, %struct.L3* %20, i32 0, i32 1
  store %struct.L3* %19, %struct.L3** %21, align 8
  %22 = load %struct.L3*, %struct.L3** %3, align 8
  %23 = load %struct.L3**, %struct.L3*** %2, align 8
  store %struct.L3* %22, %struct.L3** %23, align 8
  ret void
}

; Function Attrs: noinline nounwind uwtable
define internal void @l4_insert(%struct.L4** %0, i8* %1) #0 {
  ...
  store i8* %1, i8** %4, align 8
  %6 = call i8* @zalloc_or_die(i32 24)
  %7 = bitcast i8* %6 to %struct.L4*
  store %struct.L4* %7, %struct.L4** %5, align 8
  %8 = call i8* @zalloc_or_die(i32 119)
  %9 = bitcast i8* %8 to %struct.L5*
  %10 = load %struct.L4*, %struct.L4** %5, align 8
  %11 = getelementptr inbounds %struct.L4, %struct.L4* %10, i32 0, i32 2
  store %struct.L5* %9, %struct.L5** %11, align 8
  %12 = load %struct.L4*, %struct.L4** %5, align 8
  %13 = bitcast %struct.L4* %12 to i8*
  %14 = load %struct.L4*, %struct.L4** %5, align 8
  %15 = getelementptr inbounds %struct.L4, %struct.L4* %14, i32 0, i32 2
  %16 = load %struct.L5*, %struct.L5** %15, align 8
  %17 = bitcast %struct.L5* %16 to i8**
  store i8* %13, i8** %17, align 8
  %18 = load i8*, i8** %4, align 8
  %19 = bitcast i8* %18 to %struct.L3**
  %20 = load %struct.L4*, %struct.L4** %5, align 8
  %21 = getelementptr inbounds %struct.L4, %struct.L4* %20, i32 0, i32 0
  store %struct.L3** %19, %struct.L3*** %21, align 8
  %22 = load %struct.L4**, %struct.L4*** %3, align 8
  %23 = load %struct.L4*, %struct.L4** %22, align 8
  %24 = load %struct.L4*, %struct.L4** %5, align 8
  %25 = getelementptr inbounds %struct.L4, %struct.L4* %24, i32 0, i32 1
  store %struct.L4* %23, %struct.L4** %25, align 8
  %26 = load %struct.L4*, %struct.L4** %5, align 8
  %27 = load %struct.L4**, %struct.L4*** %3, align 8
  store %struct.L4* %26, %struct.L4** %27, align 8
  ret void
}
