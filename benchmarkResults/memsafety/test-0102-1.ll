; ModuleID = '/home/curt/HeapDataFlow/benchmarkResults/memsafety/test-0102-1.bc'
source_filename = "/home/curt/HeapDataFlow/sv-benchmarks/c/memsafety/test-0102-1.c"
...
@.str.1 = private unnamed_addr constant [64 x i8] c"/home/curt/HeapDataFlow/sv-benchmarks/c/memsafety/test-0102-1.c\00", align 1
...
16:                                               ; preds = %11
  ...
  %27 = getelementptr inbounds %struct.top_list, %struct.top_list* %26, i32 0, i32 2
  call void @destroy_sub(%struct.list_head* %27)
  %28 = load %struct.top_list*, %struct.top_list** %3, align 8
  %29 = bitcast %struct.top_list* %28 to i8*
  call void @free(i8* %29) #5
  %30 = load %struct.top_list*, %struct.top_list** %4, align 8
  store %struct.top_list* %30, %struct.top_list** %3, align 8
  br label %11
