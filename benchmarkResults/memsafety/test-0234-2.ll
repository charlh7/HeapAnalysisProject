; ModuleID = '/home/curt/HeapDataFlow/benchmarkResults/memsafety/test-0234-2.bc'
source_filename = "/home/curt/HeapDataFlow/sv-benchmarks/c/memsafety/test-0234-2.c"
...
@.str.1 = private unnamed_addr constant [64 x i8] c"/home/curt/HeapDataFlow/sv-benchmarks/c/memsafety/test-0234-2.c\00", align 1
...
4:                                                ; preds = %11, %1
  ...
  %6 = getelementptr inbounds %struct.L4, %struct.L4* %5, i32 0, i32 0
  %7 = load %struct.L4*, %struct.L4** %6, align 8
  store %struct.L4* %7, %struct.L4** %3, align 8
  %8 = load %struct.L4*, %struct.L4** %2, align 8
  %9 = bitcast %struct.L4* %8 to i8*
  call void @free(i8* %9) #6
  %10 = load %struct.L4*, %struct.L4** %3, align 8
  store %struct.L4* %10, %struct.L4** %2, align 8
  br label %11

11:                                               ; preds = %4
  %12 = load %struct.L4*, %struct.L4** %2, align 8
  %13 = icmp ne %struct.L4* %12, null
